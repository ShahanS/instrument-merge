...
public class LmeAndPrimeInstrumentLmePublishMergeRuleTest {
    private LmeAndPrimeInstrumentLmePublishMergeRule underTest;

    @Before
    public void setUp() {
        underTest = new LmeAndPrimeInstrumentLmePublishMergeRule(Source.LME.name());
    }
